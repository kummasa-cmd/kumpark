...
export const metadata: Metadata = {
  title: "검파크소개",
  description:
    "루틴의 설계 베스트셀러 작가 홍성호의 작품 활동과 경력을 소개합니다. 11권 전자책, 1권 종이책 출간.",
};

const ebooks = [
  { year: "2024.03", title: "3달만에 0에서 5천 인플루언서 블로거가 되는 법", genre: "자기계발" },
  { year: "2024.03", title: "평범한 블로거를 3달 만에 베스트셀러작가로 만든 비결", genre: "자기계발" },
  { year: "2024.05", title: "B형 남자", genre: "에세이" },
  { year: "2024.07", title: "극복하지 못해도 괜찮아", genre: "자기계발" },
  { year: "2024.09", title: "50대에 시작하는 SNS", genre: "자기계발" },
  { year: "2024.12", title: "블로그 1년, 두근거리는 인생 2막의 시작", genre: "자기계발" },
  { year: "2025.02", title: "글쓰기 초보를 위한 SNS 글감 찾기", genre: "자기계발" },
  { year: "2025.09", title: "한 번뿐인 인생을 깨우는 5가지 키워드", genre: "자기계발" },
  { year: "2025.12", title: "꾸준함 관리 비법", genre: "자기계발" },
  { year: "2026.01", title: "코드를 짜던 사람이 삶을 기록하기 시작했다", genre: "에세이" },
  { year: "2026.05", title: "오십, 내 인생은 아직 끝나지 않았다", genre: "자기계발" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <section className="mb-16">
          ...
          <div className="bg-green-50 rounded-xl p-6 flex items-center justify-between">
            <div>
              <p className="text-xs text-brand-muted mb-1">모모북스 · 2025.08</p>
              <p className="text-lg font-bold text-brand-text">루틴의 설계</p>
              <p className="text-sm text-brand-muted mt-1">자기계발</p>
            </div>
